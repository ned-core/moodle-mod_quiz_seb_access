...
$string['setting:lockconfigafterattempt'] = 'Lock settings if quiz attempted';
$string['setting:lockconfigafterattempt_desc'] = 'If enabled, a quiz\'s Safe Exam Browser settings are locked when a quiz has been attempted.';
...
$string['attemptswarning'] = 'There has been at least one quiz attempt. Changing Safe Exam Browser settings now means that subsequent attempts are made under different exam conditions which may be unfair to participants.';
